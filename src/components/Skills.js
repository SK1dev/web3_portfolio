  ...
  return (
    <section className="skills">
      ...
      <p>
        ...
        <br></br>
        <li>
          <strong>Development Environments:</strong> Hardhat, Truffle, Brownie,
          Ganache and Remix.
        </li>
        <br></br>
        <li>JavaScript ETH Libraries: Web3.js and Ethers.js</li>
        <br></br>
        <li>
          Familiarity with DeFi protocols and implementation of OpenZeppelin’s
        ...
        <br></br>
        <li>
          Good knowledge of most prominent ERC/EIP Ethereum standards. ERC-20 /
          721 / 777 / 1155 and others.
        </li>
        <br></br>
